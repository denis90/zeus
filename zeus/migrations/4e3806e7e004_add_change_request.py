...
Revision ID: 4e3806e7e004
Revises: 9418cac1c4ee
Create Date: 2017-11-19 21:26:48.481669
...
def upgrade():
    ...
    op.create_index('idx_cr_repo_sha', 'change_request', [
...
def downgrade():
    ...
    op.drop_index('idx_cr_repo_sha', table_name='change_request')
